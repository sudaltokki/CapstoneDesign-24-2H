...
|09|[보성말차](#team-09)| C.LOVA : Multimodal LLM을 통해 학교 내 분실물을 쉽고 효율적으로 등록, 관리, 찾을 수 있는 웹서비스"
...
# Team-09
| (1) 과제명 | C.LOVA : Multimodal LLM을 통해 학교 내 분실물을 쉽고 효율적으로 등록, 관리, 찾을 수 있는 웹서비스
|:---  |---  |
| (2) 팀 번호 / 팀 이름 | 09-보성말차 |
| (3) 팀원 역할 분담 | 이서영(2029028) : 리더, ???   <br> 김민영(2073028) : 팀원, ???   <br> 이정은(2128020) : 팀원, ???   |
| (4) 팀 지도교수 | 오세은 |
| (5) 팀 멘토 | 정아연 / 개발자 / 라인플러스 |
| (6) 과제 키워드(keywords) | LLM, DB, WEB |
| (7) 과제 내용 요약 | <과제내용에 대한 요약을 작성 바람니다> |
| (10) 기타 |  |
...
| (7) 과제 내용 요약 | 불법주정차 신고절차를 자동화하는 서비스로, 블랙박스 데이터를 활용하여 불법주정차를 AI로 탐지, 이후 클라우드 내 메타데이터 간 비교분석을 수행하여 준법 여부를 가려내어(한자어가 더 좋을듯) 해당 차량이 자동으로 신고되게 하고자 한다. |
| (10) 기타 |  |
